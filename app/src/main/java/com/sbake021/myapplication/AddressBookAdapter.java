 ...
 */
public class AddressBookAdapter extends RecyclerView.Adapter<AddressBookAdapter.ContactViewHolder> {
    ...
    /**
     * Constructor for AddressBookAdapter.
     * @param arrayList The list of contacts to display.
     * @param context The context in which the adapter is being used.
     */
    public AddressBookAdapter(ArrayList<Contact> arrayList, Context context) {
     ...
     * @param b True to enable delete functionality, false to disable.
     */
    ...
    public class ContactViewHolder extends RecyclerView.ViewHolder {
        public TextView textName, textAddress, textCity, textState, textZipCode, textPhone, textEmail;
        ...
        public ContactViewHolder(@NonNull View itemView) {
            ...
            textPhone = itemView.findViewById(R.id.textView_phone); // Ensure correct ID
            textEmail = itemView.findViewById(R.id.textView_email); // Ensure correct ID
